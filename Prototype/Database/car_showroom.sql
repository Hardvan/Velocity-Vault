...
CREATE TABLE `car_features` (
  ...
  `first_reistration` varchar(10) NOT NULL,
...
INSERT INTO `car_features` (`car_ID`, `car_name`, `image_link`, `price`, `type`, `make`, `model`, `first_reistration`, `mileage`, `fuel`, `engine_size`, `power`, `gearbox`, `no_of_seats`, `doors`, `color`, `Description`) VALUES
